...
Serverless Components are simple abstractions for the Serverless Framework that enable you to deploy powerful serverless applications and use-cases, easily.
