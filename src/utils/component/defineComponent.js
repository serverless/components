import { all, forEachIndexed, forEachObjIndexed, isArray, isFunction, isObject, map } from '@serverless/utils'
...
const defineComponent = async (component, context) => {
  ...
  if (isFunction(component.define)) {
    ...
    if (isObject(children)) {
      ...
      throw new Error(`define() method must return either an object or an array. Instead received ${children} from ${component}.`)
    }
